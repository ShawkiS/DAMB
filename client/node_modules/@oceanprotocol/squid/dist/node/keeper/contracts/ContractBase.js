...
var ContractBase = (function (_super) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4, contractHandler.get(this.contractName)];
                    case 1:
                        _a.contract = _b.sent();
                        return [2];
                }
    ...
    ContractBase.prototype.searchMethod = function (methodName, args) {
        ...
        var methods = this.contract.options.jsonInterface
            .map(function (method) { return (__assign({}, method, { signature: method.signature })); })
