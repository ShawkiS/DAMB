...
var GenericContract = (function (_super) {
    __extends(GenericContract, _super);
    function GenericContract(contractName) {
        return _super.call(this, contractName) || this;
    }
    GenericContract.getInstance = function (config, contractName) {
        return __awaiter(this, void 0, void 0, function () {
            var contract;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        contract = new GenericContract(contractName);
                        return [4, contract.init(config)];
                    case 1:
                        _a.sent();
                        return [2, contract];
                }
