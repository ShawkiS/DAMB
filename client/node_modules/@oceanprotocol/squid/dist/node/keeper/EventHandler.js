    ...
    EventHandler.prototype.checkBlock = function (isInterval, n) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.web3.eth.getBlockNumber()];
                    case 1:
                        blockNumber = _a.sent();
                        ...
                        if (this.lastBlock !== blockNumber) {
                            this.events.forEach(function (fn) { return fn(_this.lastBlock + 1); });
                            this.lastBlock = blockNumber;
                        }
                        this.lastTimeout = setTimeout(function () { return _this.checkBlock(true, n++); }, this.interval);
                        return [2];
                }
            });
        });
