...
var SignatureUtils = (function (_super) {
    __extends(SignatureUtils, _super);
    function SignatureUtils(config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.trys.push([3, 5, , 6]);
                        return [4, this.web3.eth.sign(text, publicKey, password)];
    ...
    SignatureUtils.prototype.verifyText = function (text, signature) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.web3.eth.personal.ecRecover(text, signature)];
                    case 1: return [2, _a.sent()];
                }
            });
        });
